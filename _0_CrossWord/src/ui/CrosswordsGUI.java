...
public class CrosswordsGUI {
	...
	@SuppressWarnings("rawtypes")
	private JComboBox selectGridHeight;
	@SuppressWarnings("rawtypes")
	private JComboBox selectGridWidth;
	...
	Boolean ValidConfiguration(){
		...
		Config.GridRows = Integer.parseInt((String) selectGridHeight.getSelectedItem());
		Config.GridColumns = Integer.parseInt((String) selectGridWidth.getSelectedItem());
		//grid size
...
//		panelConfig.add(selectGridSize);
		...
		selectGridHeight = new JComboBox(Config.OptionsGridHeight);
		selectGridHeight.setBounds(280, 87, 66, 20);
		panelConfig.add(selectGridHeight);
		selectGridHeight.setSelectedIndex(9);
		
		//grid width
		selectGridWidth = new JComboBox(Config.OptionsGridWidth);
		selectGridWidth.setBounds(280, 118, 66, 20);
		panelConfig.add(selectGridWidth);
		selectGridWidth.setSelectedIndex(9);
		...
		//label rows / columns
		JLabel lblRows = new JLabel("Grid Height");
		lblRows.setForeground(Color.DARK_GRAY);
		lblRows.setBounds(119, 90, 151, 14);
		panelConfig.add(lblRows);
		
		//label rows / columns
		JLabel lblColumns = new JLabel("Grid Width");
		lblColumns.setForeground(Color.DARK_GRAY);
		lblColumns.setBounds(119, 121, 151, 14);
		panelConfig.add(lblColumns);
